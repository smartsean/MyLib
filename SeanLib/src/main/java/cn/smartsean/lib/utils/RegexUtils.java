...
import cn.smartsean.lib.constants.RegexConstants;
 ...
 * 正则相关工具类
 *
 * @author SmartSean on  17/8/21 12:29
 */
...
public final class RegexUtils {
    ...
    /**
     * 验证密码规则，密码6-20位，由数字、字母和下划线组成
     * @param input
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isMatchPwd(final CharSequence input) {
